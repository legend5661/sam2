...
from sam2.modeling.backbones.image_encoder3D import LayerNorm3d
...
class MaskDownSampler(nn.Module):
    ...
    With each downsample (by a factor stride**3), channel capacity increases by the same factor.
