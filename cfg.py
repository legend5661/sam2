...
def parse_args():    
    ...
    parser.add_argument('-sam_config', type=str, default='configs/sam2.1/sam2.1_hiera_b+_3d.yaml' , help='sam config address')
    parser.add_argument('-video_length', type=int, default=4, help='vide length')
    ...
    '-data_path',
    type=str,
    default='/staff/wangtiantong/SAM2/data/acdc_test',
