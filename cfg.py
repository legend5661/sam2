...
def parse_args():    
    ...
    parser.add_argument('-dataset', default='mydataset' ,type=str,help='dataset name')
    parser.add_argument('-sam_ckpt', type=str, default='/staff/wangtiantong/SAM2/sam2-main/sam2/configs/sam2.1/sam2.1_hiera_b+_3d.yaml' , help='sam checkpoint address')
    parser.add_argument('-sam_config', type=str, default=None , help='sam config address')
    ...
    '-data_path',
    type=str,
    default='/staff/wangtiantong/SAM2/data/hanseg',
